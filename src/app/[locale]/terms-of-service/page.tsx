...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: "Read the Terms of Service for Esports Manager 2026 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Esports Manager 2026 Wiki",
      description: "Terms and conditions for using Esports Manager 2026 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Esports Manager 2026 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Esports Manager 2026 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Esports Manager 2026 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Esports Manager 2026 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Esports Manager 2026". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Beginner guides and management strategies</li>
              <li>Player scouting, transfer, and contract guides</li>
              <li>Team and real organization information</li>
              <li>Training, morale, and staff guides</li>
              <li>Tactics, finances, and tournament guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Esports Manager 2026 Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Esports Manager 2026. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Esports Manager 2026 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Esports Manager 2026. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ESPORTS MANAGER 2026 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Esports Manager 2026 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@esportsmanager2026.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@esportsmanager2026.online</a>
            </p>
            <p>
