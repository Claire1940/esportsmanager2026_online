...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Esports Manager 2026 Wiki',
    description: 'Copyright and intellectual property information for Esports Manager 2026 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Esports Manager 2026 Wiki',
      description: 'Copyright and intellectual property information for Esports Manager 2026 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Esports Manager 2026 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Esports Manager 2026 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Esports Manager 2026 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Neurona Games</strong> - Developer of Esports Manager 2026</li>
              <li><strong>indie.io</strong> - Publisher of Esports Manager 2026</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Esports Manager 2026</strong> - Trademark of Neurona Games</li>
              <li><strong>Esports Manager 2026 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Esports Manager 2026 Wiki.
            </p>
            ...
            <p>
              ...
              Esports Manager 2026 Wiki<br />
              Email: <a href="mailto:dmca@esportsmanager2026.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@esportsmanager2026.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Esports Manager 2026 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Esports Manager 2026 Wiki (esportsmanager2026.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@esportsmanager2026.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@esportsmanager2026.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@esportsmanager2026.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@esportsmanager2026.online</a>
            </p>
            <p>
